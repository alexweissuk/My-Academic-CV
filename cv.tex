...
\usepackage[style=apacv,sorting=ydnt,backend=biber,uniquename=false]{biblatex}
...
\begin{tabular}{p{15cm}}
  ...
  Multivariate statistics/data science
...
\begin{tabular}{p{3cm}p{12cm}}
  ...
  2013 & ``The majority of genetic variation in orangutan
         personality and subjective well-being is nonadditive'' recognized by 
         Fulker Award for best paper in \textit{Behavior Genetics} \\ \\
